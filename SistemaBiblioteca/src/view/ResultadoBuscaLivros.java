 ...
 * @author danie
 */
public class ResultadoBuscaLivros extends javax.swing.JFrame {

    /**
     * Creates new form TelaLogin
     */
    public ResultadoBuscaLivros() {
        initComponents();
    }
    ...
    private void jMenu1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jMenu1MouseClicked
        ...
        new ResultadoBuscaLivros().setVisible(true);
        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ResultadoBuscaLivros.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
